...
declare function damageReducer(
  ...
  prevDamage?: number,
  damageTaken?: number,
): (totalDamage: number, damage: Damage) => number;
/**
 ...
 */
declare function addEffectApplicatorTemplateData(
  data: StringDictionary<string>,
  applicator: AnyCombatEffectApplicator,
  preHit: boolean,
  idx: number,
): void;
/**
 ...
 */
declare function addDamageTemplateData(
  data: StringDictionary<string>,
  damage: Damage[],
  prefix: string,
): void;
...
declare const attackDescriptions: {
  ...
  attackDescriptors: StringDictionary<
    (attack: SpecialAttack, attackerNoun: Noun, targetNoun: Noun) => string
  >;
  youNoun: Noun;
  enemyNoun: Noun;
};
declare const generateAttackDescription: (
  attack: SpecialAttack,
  attackerNoun: Noun,
  targetNoun: Noun,
) => string;
declare const attackDescriptors: StringDictionary<
  (attack: SpecialAttack, attackerNoun: Noun, targetNoun: Noun) => string
>;
