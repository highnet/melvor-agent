declare enum BankSortOrderSetting {
  Default = 0,
...
declare enum NumberFormatSetting {
  ShowThousands = 0,
  CondenseThousands = 1,
}
declare enum BankBorderSetting {
  Default = 0,
  Minimal = 1,
}
declare enum ColourBlindModeSetting {
  None = 0,
  RedGreen = 1,
}
declare enum MapTextureQuality {
  Low = 0,
  Medium = 1,
  High = 2,
}
declare enum SidebarLevelSetting {
  Both = 0,
  Normal = 1,
  Abyssal = 2,
}
...
declare class Settings implements EncodableObject, BooleanSettings, ChoiceSettings {
  ...
  changeChoiceSetting<T extends keyof ChoiceSettings>(
    setting: T,
    newValue: ChoiceSettings[T],
  ): void;
