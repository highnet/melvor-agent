...
declare class Game extends GameEventEmitter<GameEvents> implements Serializable, EncodableObject {
  ...
  queueForSoftDependencyReg<DataType>(
    data: DataType,
  ...
  registerOldAttackSpellData(
    namespace: DataNamespace,
    data: OldAttackSpellData[],
    spellbook: string,
  ): void;
  ...
  registerSkill<T extends AnySkill>(
    namespace: DataNamespace,
    constructor: new (
      namespace: DataNamespace,
      game: Game,
  ...
  getCombatEffectApplicatorsFromData(
    data: AnyCombatEffectApplicatorData[],
  ): AnyCombatEffectApplicator[];
  /** Constructs a Single or Table CombatEffectApplicator from data */
  getCombatEffectApplicatorWithTriggerFromData(
    data: TriggeredCombatEffectApplicatorData,
  ): AnyCombatEffectApplicator;
  /** Constructs an array of Single or Table CombatEffectApplictors from an array of data */
  getCombatEffectApplicatorsWithTriggersFromData(
    data: TriggeredCombatEffectApplicatorData[],
  ): AnyCombatEffectApplicator[];
  /** Applies modification data to a CombatEffectApplicator array. Removals are processed before additions. */
  modifyCombatEffectApplicators(
    applicators: CombatEffectApplicator[],
    modData: CombatEffectApplicatorModificationData,
    className?: string,
  ): void;
  ...
  modifyRequirements(
    ...
    modData: RequirementsModificationData,
  ): AnyRequirement[];
  ...
  modifyCurrencyQuantities(
    quantities: CurrencyQuantity[],
    data: CurrencyQuantitiesModificationData,
  ): CurrencyQuantity[];
  ...
  constructDummyObject<T>(
    id: string,
    constructor: new (namespace: DataNamespace, localID: string, game: Game) => T,
  ): T;
  startMainLoop(): void;
  stopMainLoop(): void;
  ...
  trackOfflineTelemetry(
    oldSnapshot: OfflineSnapshot,
    newSnapshot: OfflineSnapshot,
    timeDiff: number,
  ): void;
  ...
  increaseSkillLevelCaps(
    capIncrease: SkillLevelCapIncrease,
    reqSet: SkillLevelCapRequirementSet,
  ): void;
  ...
  selectRandomLevelCapIncrease(
    capIncrease: SkillLevelCapIncrease,
    increase: SkillCapIncrease,
  ): void;
