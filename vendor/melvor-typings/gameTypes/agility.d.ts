...
declare abstract class BaseAgilityObject
  extends MasteryAction
  implements SoftDataDependant<BaseAgilityObjectData>
{
...
declare type AgilityObstacleSkillRequirementData =
...
declare class AgilityObstacle extends BaseAgilityObject {
  ...
  getSkillRequirements(
    reqData: (SkillLevelRequirementData | AbyssalLevelRequirementData)[],
    game: Game,
  ): (SkillLevelRequirement | AbyssalLevelRequirement)[];
}
...
> {
  ...
  forEachActiveObstacle(
    obstacleCallback: (obstacle: AgilityObstacle) => void,
    pillarCallback: (pillar: AgilityPillar) => void,
  ): void;
