declare abstract class CombatSkill<
  DataType extends BaseSkillData = BaseSkillData,
  ModificationDataType extends BaseSkillModificationData = BaseSkillModificationData,
> extends Skill<DataType, SkillEvents, ModificationDataType> {
