declare class BinaryWriter {
   ...
   */
  getMap<T, U>(
    decodeKey: (reader: this) => T | undefined,
    decodeValue: (reader: this, key: T | undefined) => U | undefined,
  ): Map<T, U>;
  /**
  ...
  writeMap<T, U>(
    map: Map<T, U>,
    encodeKey: (key: T, writer: this, value: U) => void,
    encodeValue: (value: U, writer: this, key: T) => void,
  ): void;
  /**
   ...
   */
  writeSparseNumericMap<T>(
    map: SparseNumericMap<T>,
    encodeKey: (key: T, writer: this) => void,
  ): void;
  /**
...
declare function readNamespacedReject<T extends NamespacedObject>(
  registry: NamespaceRegistry<T>,
): (reader: SaveWriter) => T | undefined;
