...
declare type AnyItemModificationData =
...
declare class Item extends NamespacedObject implements IGameEventEmitter<ItemEvents> {
  ...
  on: {
    <Key extends keyof ItemEvents>(
      type: Key,
      handler: import('mitt').Handler<ItemEvents[Key]>,
    ): void;
  ...
  off: {
    <Key extends keyof ItemEvents>(
      type: Key,
      handler?: import('mitt').Handler<ItemEvents[Key]> | undefined,
    ): void;
    (type: '*', handler: import('mitt').WildcardHandler<ItemEvents>): void;
  };
  emit: {
    <Key extends keyof ItemEvents>(type: Key, event: ItemEvents[Key]): void;
    <Key_1 extends keyof ItemEvents>(
      type: undefined extends ItemEvents[Key_1] ? Key_1 : never,
    ): void;
  };
...
interface BaseEquipmentItemModificationData
  extends BaseItemModificationData,
...
declare class EquipmentItem
  extends Item
  implements SoftDataDependant<EquipmentItemData>, IStatObject
{
