...
declare abstract class CombatEffectTTSpan {
  ...
  constructor(
    data: CombatEffectTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
  ...
  getExpressionRecord(
    data: Record<string, CombatEffectNumberExpression>,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  ): Record<string, CombatEffectNumberFunc>;
  /** Evaluates a record of expressions into a record of strings */
  evalExpressionRecord(
    exprRecord: Record<string, CombatEffectNumberFunc>,
    activeEffect: ActiveCombatEffect,
...
declare class CombatEffectLangTTSpan extends CombatEffectTTSpan {
  ...
  constructor(
    data: CombatEffectLangTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
...
declare class CombatEffectStringTTSpan extends CombatEffectTTSpan {
  ...
  readonly templateData?: Record<string, CombatEffectNumberFunc>;
  constructor(
    data: CombatEffectStringTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
  getSpans(activeEffect: ActiveCombatEffect): HTMLSpanElement[];
...
declare class CombatEffectStatsTTSpan extends CombatEffectTTSpan {
  ...
  constructor(
    data: CombatEffectStatsTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
  getSpans(activeEffect: ActiveCombatEffect): HTMLSpanElement[];
...
declare class CombatEffectTurnsTTSpan extends CombatEffectTTSpan {
  ...
  constructor(
    data: CombatEffectTurnsTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
  getSpans(activeEffect: ActiveCombatEffect): HTMLSpanElement[];
...
declare class CombatEffectStacksWithMaxTTSpan extends CombatEffectTTSpan {
  ...
  constructor(
    data: CombatEffectStacksWithMaxTTSpanData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener: CombatEffectRenderListener,
  );
  getSpans(activeEffect: ActiveCombatEffect): HTMLSpanElement[];
}
declare type AnyCombatEffectTTSpanData =
...
declare type CombatEffectData = PickRequired<
  BaseCombatEffectData,
  'name' | 'media' | 'target' | 'behaviours'
> &
  IDData;
...
declare class BehaviourTriggerCondition {
  ...
  constructor(
    data: BehaviourTriggerConditionData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    listener?: CombatEffectRenderListener,
  );
}
...
declare abstract class CombatBehaviourTrigger<Event extends GameEvent> {
  ...
  constructor(
    data: CombatBehaviourTriggerData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  /**
...
declare class EndOfTurnTrigger extends CombatBehaviourTrigger<CharacterEndOfTurnEvent> {
  ...
  _assignHandler(
    handler: Handler<CharacterEndOfTurnEvent>,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): void;
  _unassignHandler(
...
declare class HitWithAttackTrigger extends CombatBehaviourTrigger<CharacterAttackEvent> {
  ...
  _assignHandler(
    handler: Handler<CharacterAttackEvent>,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): void;
  _unassignHandler(
...
declare class MissedWithAttackTrigger extends CombatBehaviourTrigger<CharacterAttackEvent> {
  constructor(
    data: MissedWithAttackTriggerData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _assignHandler(
    handler: Handler<CharacterAttackEvent>,
...
declare class HitByAttackTrigger extends CombatBehaviourTrigger<CharacterAttackedEvent> {
  ...
  _assignHandler(
    handler: Handler<CharacterAttackedEvent>,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): void;
  _unassignHandler(
...
declare class EndOfFightTrigger extends CombatBehaviourTrigger<EndOfFightEvent> {
  ...
  _assignHandler(
    handler: Handler<EndOfFightEvent>,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): void;
  _unassignHandler(
...
declare class PrayerPointUseTrigger extends CombatBehaviourTrigger<PrayerPointConsumptionEvent> {
  ...
  _assignHandler(
    handler: Handler<PrayerPointConsumptionEvent>,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): void;
  _unassignHandler(
  ...
  doesEventMatch(
    event: PrayerPointConsumptionEvent,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): boolean;
}
...
declare class EquipmentChangedTrigger
  extends CombatBehaviourTrigger<EquipmentChangedEvent>
  implements SoftDataDependant<EquipmentChangedTriggerData>
{
...
declare class ParameterChangedTrigger extends CombatBehaviourTrigger<CombatEffectParameterChangedEvent> {
  ...
  paramName: string;
  constructor(
    data: ParameterChangedTriggerData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _assignHandler(
    handler: Handler<CombatEffectParameterChangedEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectParameterChangedEvent>,
  ...
  doesEventMatch(
    event: CombatEffectParameterChangedEvent,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): boolean;
}
...
declare class StatsChangedTrigger extends CombatBehaviourTrigger<CombatEffectStatsChangedEvent> {
  ...
  _assignHandler(
    handler: Handler<CombatEffectStatsChangedEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectStatsChangedEvent>,
  ...
  doesEventMatch(
    event: CombatEffectStatsChangedEvent,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): boolean;
}
...
declare class TimerFiredTrigger extends CombatBehaviourTrigger<CombatEffectTimerFiredEvent> {
  ...
  _assignHandler(
    handler: Handler<CombatEffectTimerFiredEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectTimerFiredEvent>,
  ...
  doesEventMatch(
    event: CombatEffectTimerFiredEvent,
    activeEffect: ActiveCombatEffect,
    character: Character,
  ): boolean;
}
...
declare class EffectAppliedTrigger extends CombatBehaviourTrigger<CombatEffectAppliedEvent> {
  ...
  _assignHandler(
    handler: Handler<CombatEffectAppliedEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectAppliedEvent>,
...
declare class EffectReappliedTrigger extends CombatBehaviourTrigger<CombatEffectReappliedEvent> {
  constructor(
    data: EffectReappliedTriggerData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _assignHandler(
    handler: Handler<CombatEffectReappliedEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectReappliedEvent>,
...
declare class EffectRemovedTrigger extends CombatBehaviourTrigger<CombatEffectRemovedEvent> {
  ...
  _assignHandler(
    handler: Handler<CombatEffectRemovedEvent>,
    activeEffect: ActiveCombatEffect,
  ): void;
  _unassignHandler(
    handler: Handler<CombatEffectRemovedEvent>,
...
declare abstract class CombatEffectBehaviour {
  ...
  priority: number;
  constructor(
    data: CombatEffectBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  ...
  constructTrigger(
    data: AnyCombatEffectBehaviourTriggerData,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
    game: Game,
  ): CombatBehaviourTrigger<GameEvent>;
  ...
  static registerTrigger<T extends keyof BehaviourTriggerNameMap>(
    name: T,
    constructor: BehaviourTriggerNameMap[T],
  ): void;
...
declare class InterruptTurnBehaviour extends CombatEffectBehaviour {
  constructor(
    data: InterruptTurnBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
...
declare class ProcessEffectApplicatorBehaviour extends CombatEffectBehaviour {
  ...
  constructor(
    data: ProcessEffectApplicatorBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class RemoveEffectBehaviour extends CombatEffectBehaviour {
  constructor(
    data: RemoveEffectBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class ModifyParameterBehaviour extends ModifyBehaviour {
  ...
  paramName: string;
  constructor(
    data: ModifyParameterBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class DamageCharacterBehaviour extends CombatEffectBehaviour {
  ...
  damageType?: DOTType;
  constructor(
    data: DamageCharacterBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class DamageBarrierBehaviour extends CombatEffectBehaviour {
  ...
  damageType?: DOTType;
  constructor(
    data: DamageBarrierBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class HealCharacterBehaviour extends CombatEffectBehaviour {
  ...
  value: CombatEffectNumberFunc;
  constructor(
    data: HealCharacterBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class UpdatePrayerModifiersBehaviour extends CombatEffectBehaviour {
  ...
  constructor(
    data: UpdatePrayerModifiersBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class ApplyCorruptionBehaviour extends CombatEffectBehaviour {
  ...
  constructor(
    data: ApplyCorruptionBehaviourData,
    game: Game,
    transpiler: IExprTranspiler<CombatEffectNumberFunc>,
  );
  _execute(character: Character, activeEffect: ActiveCombatEffect): void;
...
declare class CombatEffect extends NamespacedObject {
  ...
  static registerBehaviour<T extends keyof CombatBehaviourNameMap>(
    name: T,
    constructor: CombatBehaviourNameMap[T],
  ): void;
...
declare type AnyCombatEffectBehaviourData =
...
declare type CombatEffectApplicatorConditionData =
  | CombatConditionData
  | DamageDealtConditionData
  | DamageTakenConditionData
  | CharacterNamedValueConditionData
  | EveryCondition<CombatEffectApplicatorConditionData>
  | SomeCondition<CombatEffectApplicatorConditionData>;
declare type CombatEffectApplicatorCondition =
  | AnyCharacterCondition
  | DamageDealtCondition
  | DamageTakenCondition
  | CharacterNamedValueCondition
  | EveryCondition<CombatEffectApplicatorCondition>
  | SomeCondition<CombatEffectApplicatorCondition>;
...
declare abstract class CombatEffectApplicator {
  ...
  getConditionFromData(
    data: CombatEffectApplicatorConditionData,
    game: Game,
  ): CombatEffectApplicatorCondition;
  ...
  static compareConditions(
    condA: CombatEffectApplicatorCondition,
    condB: CombatEffectApplicatorCondition,
  ): boolean;
}
...
declare class TableCombatEffectApplicator extends CombatEffectApplicator {
  ...
  static fromDataWithTrigger(
    data: TableCombatEffectApplicatorData & CombatEffectApplicatorTriggerData,
    game: Game,
  ): TableCombatEffectApplicator;
}
...
declare class SingleCombatEffectApplicator extends CombatEffectApplicator {
  ...
  static fromDataWithTrigger(
    data: SingleCombatEffectApplicatorData & CombatEffectApplicatorTriggerData,
    game: Game,
  ): SingleCombatEffectApplicator;
}
/** Different times in combat when effects provided outside of special attacks can be applied */
declare type CombatEffectApplicationTrigger =
  | 'PreAttack'
  | 'HitByAttack'
  | 'HitByFirstAttack'
  | 'HitWithAttack'
...
declare type AnyCombatEffectApplicatorData =
...
declare type TriggeredCombatEffectApplicatorData = AnyCombatEffectApplicatorData &
...
declare class ActiveCombatEffect
  extends GameEventEmitter<ActiveCombatEffectEvents>
