...
declare class Runecrafting
  extends ArtisanSkill<
    RunecraftingRecipe,
  ...
  >
  implements SkillCategoryObject<SkillCategory>
{
...
interface RunecraftingRecipeModificationData
  extends SingleProductArtisanSkillRecipeModificationData {
  subcategories?: {
    add?: string[];
    remove?: string[];
  };
