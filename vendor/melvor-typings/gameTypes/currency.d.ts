...
declare enum CurrencyStats {
  TotalEarned = 0,
  TotalSpent = 1,
  EarnedFromCombat = 2,
  SpentInShop = 3,
}
declare enum SkillCurrencyStats {
  Earned = 0,
  Spent = 1,
  Preserved = 2,
  SpentTravelling = 3,
...
declare abstract class Currency
  ...
  implements EncodableObject, IGameEventEmitter<CurrencyEvents>
{
  game: Game;
  _events: import('mitt').Emitter<CurrencyEvents>;
  on: {
    <Key extends 'amountChanged'>(
      type: Key,
      handler: import('mitt').Handler<CurrencyEvents[Key]>,
    ): void;
  ...
  off: {
    <Key extends 'amountChanged'>(
      type: Key,
      handler?: import('mitt').Handler<CurrencyEvents[Key]> | undefined,
    ): void;
    (type: '*', handler: import('mitt').WildcardHandler<CurrencyEvents>): void;
  };
  get media(): string;
