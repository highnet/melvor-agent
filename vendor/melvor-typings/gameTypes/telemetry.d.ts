declare class Telemetry {
  ...
  getExistingTelemetryEvent(
    eventType: TelemetryEventID,
    eventID: string,
...
declare type TelemetryEventID =
  | 'monster_killed'
  | 'player_death'
  | 'offline_xp_gain'
  | 'offline_abyssal_xp_gain'
  | 'online_xp_gain'
  | 'online_abyssal_xp_gain'
  | 'item_gained'
  | 'item_removed_from_bank'
  | 'gp_adjusted'
  | 'ap_adjusted';
...
declare type TelemetryEvents =
  | MonsterKilledTelemetryEvent
  | PlayerDeathTelemetryEvent
  | OfflineXPGainTelemetryEvent
  | OnlineXPGainTelemetryEvent
  | ItemGainedTelemetryEvent
  | ItemRemovedFromBankTelemetryEvent
  | GPAdjustedTelemetryEvent
  | APAdjustedTelemetryEvent
  | OfflineAXPGainTelemetryEvent
  | OnlineAXPGainTelemetryEvent;
declare type TelemetryEventPayload =
  | MonsterKilledTelemetryEventPayload
  | PlayerDeathTelemetryEventPayload
  | OfflineXPGainTelemetryEventPayload
  | OnlineXPGainTelemetryEventPayload
  | ItemGainedEventPayload
  | ItemRemovedFromBankEventPayload
  | GPAdjustedEventPayload;
