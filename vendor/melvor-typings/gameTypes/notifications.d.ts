...
declare type AnyNotification =
  | GenericNotification
  | AddItemNotification
  | RemoveItemNotification
  | SummoningMarkNotification
  | ErrorNotification
  | SuccessNotification
  | InfoNotification
  | SkillXPNotification
  | AbyssalXPNotification;
declare type NotificationType =
  ...
  | 'AddCurrency'
  | 'RemoveCurrency';
declare enum NotificationHorizontalPositions {
  LEFT = 0,
  CENTER = 1,
  RIGHT = 2,
}
...
declare class NotificationsManager {
  ...
  getBorderColour(
    ...
    notification: NotificationData,
  ): '#1b9f12' | '#e56767' | '#5cace5' | 'yellow' | 'green' | '#30c78d' | 'red';
