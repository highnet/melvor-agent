...
declare class PointOfInterest
  ...
  implements SoftDataDependant<PointOfInterestData>
{
...
declare enum FastTravelSaveState {
  None = 0,
  Unlocked = 1,
  Locked = 2,
}
...
declare function generateHexData(
  top: number,
  bottom: number,
  left: number,
  right: number,
