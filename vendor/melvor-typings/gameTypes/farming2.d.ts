...
declare class Farming
  extends SkillWithMastery<FarmingRecipe, FarmingSkillData, FarmingEvents, FarmingModificationData>
  implements PassiveAction, SkillCategoryObject<FarmingCategory>
{
  ...
  applyPrimaryProductMultipliers(
    item: Item,
    quantity: number,
    action: NamedObject,
    query: ModifierQuery,
