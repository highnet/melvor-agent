...
declare class ModifierTable {
  ...
  getModifierDescriptionsAsNodes<T extends keyof HTMLElementTagNameMap>(
    tagName: T,
  ...
  static doesQueryMatchScopeArray(
    scopeArray: ModifierScopeArray,
    queryArray: ModifierQueryArray,
  ): boolean;
