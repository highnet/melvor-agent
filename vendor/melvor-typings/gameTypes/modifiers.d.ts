...
declare class ModifierValue extends ModifierScope implements IModifierValue {
  ...
  addEffectTemplateData(
    templateData: Record<string, string>,
    prefix: string,
    postfix: string,
    mult?: number,
  ): void;
  addDescriptionTemplateData(
    templateData: Record<string, string> | undefined,
    includeSign: boolean,
    prefix: string,
    postfix: string,
  ...
  static fromIDWithRegistry(
    registry: NamespaceRegistry<Modifier>,
    id: string,
 ...
 */
declare function formatModifiers<T>(
  formatter: DescriptionFormatter<T>,
  modifiers: ModifierValue[],
  negMult?: number,
  posMult?: number,
): T[];
declare function addEffectModifierTemplateData(
