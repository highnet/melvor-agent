...
declare class WorldMapDisplayElement extends HTMLElement implements CustomElement {
  ...
  bindTooltip(
    ...
    props: Partial<Omit<TippyProps, 'getReferenceClientRect' | 'trigger'>>,
...
declare const loadModAssets: PIXI.LoaderParser<
  PIXI.Texture<PIXI.Resource> | PIXI.Texture<PIXI.Resource>[],
  IModTextureOptions,
  Record<string, any>
>;
declare function drawBoundingBox(
