...
declare class Archaeology extends GatheringSkill<
  ArchaeologyDigSite,
...
declare class ArchaeologyMuseum
  extends GameEventEmitter<ArchaeologyMuseumEvents>
