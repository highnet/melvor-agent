...
declare class TownshipConversionElement extends HTMLElement implements CustomElement {
  ...
  updateConvertToRatio(
    resource: TownshipResource,
    conversion: TownshipItemConversion,
    township: Township,
  ): void;
  updateConvertFromRatio(
    resource: TownshipResource,
    conversion: TownshipItemConversion,
    township: Township,
  ): void;
...
declare class TownshipConversionSwalElement extends HTMLElement implements CustomElement {
  ...
  setConvertButtons(
    resource: TownshipResource,
    conversion: TownshipItemConversion,
    type: TownshipConvertType,
  ): void;
  setConvertToQuantityInput(
    value: number,
    resource: TownshipResource,
    conversion: TownshipItemConversion,
  ): void;
...
declare enum TownshipTasksMenuElementMode {
  AllCategories = 0,
  TaskCategory = 1,
  CasualTasks = 2,
}
