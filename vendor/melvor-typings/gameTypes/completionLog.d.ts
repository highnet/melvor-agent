...
declare function buildCompletionProgressElements(
  ...
  name: string,
  classes: string,
): CompletionProgressElements;
declare function buildCompletionProgress(
  container: HTMLElement,
  progress: Map<string, CompletionProgressElements>,
...
declare enum CompletionCategory {
  Skills = 0,
  Mastery = 1,
  Items = 2,
  Monsters = 3,
...
declare enum VisibleCompletion {
  True = 0,
  BaseGame = 1,
  TotH = 2,
  AoD = 3,
...
declare class Completion extends GameEventEmitter<CompletionEvents> implements EncodableObject {
  ...
  updateVisbleCompletionButtons(
    oldCompletion: CompletionNamespace,
    newCompletion: CompletionNamespace,
  ): void;
  ...
  updateProgressElements(
    elementMap: Map<string, CompletionProgressElements>,
    progress: CompletionProgress,
    namespace: string,
  ): void;
  updateAllProgressElements(
    elements: Map<string, CompletionProgressElements>,
    progress: CompletionProgress,
  ): void;
  render(): void;
