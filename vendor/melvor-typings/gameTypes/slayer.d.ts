...
declare type AnySlayerTaskMonsterSelectionData =
  | CombatLevelSlayerTaskMonsterSelection
  | AbyssSlayerTaskMonsterSelectionData;
declare type AnySlayerTaskMonsterSelection =
  | CombatLevelSlayerTaskMonsterSelection
  | AbyssSlayerTaskMonsterSelection;
...
declare class SlayerTask
  extends GameEventEmitter<SlayerTaskEvents>
  implements Serializable, EncodableObject
{
  player: Player;
  game: Game;
  /** Task is active */
