...
declare enum CartographyActionMode {
  None = 0,
  QueueSurvey = 1,
  AutoSurvey = 2,
  PaperMaking = 3,
...
declare enum DiscoveryModalState {
  Closed = 0,
  GoTo = 1,
  POI = 2,
}
...
declare class Cartography
  extends Skill<CartographySkillData, CartographyEvents, CartographyModificationData>
...
declare class RandomTravelEvent
  extends NamespacedObject
  implements SoftDataDependant<RandomTravelEventData>
{
  get name(): string;
