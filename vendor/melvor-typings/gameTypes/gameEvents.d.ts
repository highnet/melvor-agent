declare type IGameEventEmitter<Events extends Record<EventType, GameEvent>> = Omit<
  Emitter<Events>,
  'all' | 'emit'
>;
...
declare type NoWildcardEventHandlerMap<Events extends Record<EventType, unknown>> = Map<
  keyof Event,
...
declare class GameEventEmitter<Events extends Record<EventType, GameEvent>>
  implements IGameEventEmitter<Events>
{
  ...
  off: {
    <Key extends keyof Events>(
      type: Key,
      handler?: import('mitt').Handler<Events[Key]> | undefined,
    ): void;
    (type: '*', handler: import('mitt').WildcardHandler<Events>): void;
  };
}
...
declare abstract class NonRaidGameEventMatcher<
  Event extends GameEvent,
> extends GameEventMatcher<Event> {
...
declare abstract class CharacterGameEventMatcher<
  Event extends GameEvent,
> extends GameEventMatcher<Event> {
  _assignHandler(handler: Handler<Event>, golbinRaid: boolean): void;
  _unassignHandler(handler: Handler<Event>, golbinRaid: boolean): void;
...
declare type GameEventMatcherData =
  ...
  | CartographyTravelEventMatcherOptions
  | ArchaeologyActionEventMatcherOptions
  | TownshipTaskCompletedEventMatcherOptions
  | HarvestingActionEventMatcherOptions
  | SoulPointConsumptionEventMatcherOptions
...
declare abstract class SkillActionEventMatcher<
  Event extends SkillActionEvent,
> extends NonRaidGameEventMatcher<Event> {
...
declare class CharacterAttackEvent
  extends IntervaledGameEvent
  implements Required<CharacterAttackEventProps>
{
  ...
  constructor(
    /** The type of attack event */
    type: 'Pre' | 'Hit' | 'Miss' | 'Post',
    props: CharacterAttackEventProps,
  );
}
...
declare class CharacterAttackedEvent
  extends GameEvent
  implements Required<CharacterAttackedEventProps>
{
