...
declare class TownshipItemGoal
  extends TownshipTaskGoal<ItemQuantityChangedEvent>
  implements ITownshipCasualTaskGoal
{
  item: AnyItem;
  quantity: number;
...
declare class TownshipCasualMonsterGoal
  extends TownshipMonsterGoal
  implements ITownshipCasualTaskGoal
{
  get progress(): number;
  _progress: number;
...
declare class TownshipMonsterWithItemsGoal
  extends TownshipTaskGoal<MonsterKilledEvent>
  implements ITownshipCasualTaskGoal
{
  monster: Monster;
  quantity: number;
...
declare class TownshipCasualSkillXPGoal
  extends TownshipSkillXPGoal
  implements ITownshipCasualTaskGoal
{
  get progress(): number;
  _progress: number;
