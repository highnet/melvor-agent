...
type BaseSkillModificationData = {};
...
declare abstract class Skill<
    DataType extends BaseSkillData,
    Events extends SkillEvents = SkillEvents,
    ModificationDataType extends BaseSkillModificationData = BaseSkillModificationData,
  >
  extends NamespacedObject
  implements EncodableObject, INoWildCardGameEventEmitter<Events>, IModifierScopeSource
{
  ...
  addCurrencyFromPrimaryProductGain(
    rewards: Rewards,
    item: Item,
    quantity: number,
    action: NamedObject,
...
declare abstract class SkillWithMastery<
    ActionType extends MasteryAction,
  ...
  >
  extends Skill<DataType, Events, ModificationDataType>
  implements Action
{
  get hasMastery(): boolean;
...
declare abstract class GatheringSkill<
    ActionType extends MasteryAction,
    DataType extends MasterySkillData,
    Events extends SkillWithMasteryEvents = SkillWithMasteryEvents,
    ModificationDataType extends MasterySkillModificationData = MasterySkillModificationData,
  >
  extends SkillWithMastery<ActionType, DataType, Events, ModificationDataType>
...
declare abstract class CraftingSkill<
  T extends MasteryAction,
  DataType extends MasterySkillData,
  Events extends SkillWithMasteryEvents,
  ModificationDataType extends MasterySkillModificationData = MasterySkillModificationData,
> extends GatheringSkill<T, DataType, Events, ModificationDataType> {
...
declare class GatheringSkillRenderQueue<
  ActionType extends MasteryAction,
> extends MasterySkillRenderQueue<ActionType> {
  progressBar: boolean;
}
