declare class Enemy extends Character implements IGameEventEmitter<CharacterCombatEvents> {
  ...
  on: {
    <Key extends keyof CharacterCombatEvents>(
      type: Key,
      handler: import('mitt').Handler<CharacterCombatEvents[Key]>,
    ): void;
  ...
  off: {
    <Key extends keyof CharacterCombatEvents>(
      type: Key,
      handler?: import('mitt').Handler<CharacterCombatEvents[Key]> | undefined,
    ): void;
    (type: '*', handler: import('mitt').WildcardHandler<CharacterCombatEvents>): void;
  };
  get type(): string;
