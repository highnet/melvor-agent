...
declare const herbloreSelectionTabs: Map<
  SkillCategory,
  RecipeSelectionTabElement<HerbloreRecipe, HerbloreRecipeOptionElement>
>;
declare let potionSelectMenu: PotionSelectMenuElement;
declare let smithingArtisanMenu: ArtisanMenuElement;
declare const smithingSelectionTabs: Map<
  SkillCategory,
  RecipeSelectionTabElement<SmithingRecipe, SmithingRecipeOptionElement>
>;
...
declare const runecraftingSelectionTabs: Map<
  SkillCategory,
  RecipeSelectionTabElement<RunecraftingRecipe, RunecraftingRecipeOptionElement>
>;
declare let craftingCategoryMenu: RealmedCategoryMenuElement;
declare let craftingArtisanMenu: ArtisanMenuElement;
declare const craftingSelectionTabs: Map<
  SkillCategory,
  RecipeSelectionTabElement<CraftingRecipe, CraftingRecipeOptionElement>
>;
declare let fletchingCategoryMenu: RealmedCategoryMenuElement;
declare let fletchingArtisanMenu: ArtisanMenuElement;
declare const fletchingSelectionTabs: Map<
  SkillCategory,
  RecipeSelectionTabElement<FletchingRecipe, FletchingRecipeOptionElement>
>;
