...
declare class RecipeSelectionTabElement<
    T extends HasLevels,
    OptionElement extends RecipeOptionElement<T> = RecipeOptionElement<T>,
  >
  extends HTMLElement
...
declare class RecipeOptionElement<T extends HasLevels>
  extends HTMLElement
  implements CustomElement
{
  get $template(): string;
...
declare class SummoningSelectionTabElement extends RecipeSelectionTabElement<
  SummoningRecipe,
  SummoningRecipeOptionElement
> {
...
declare class CategoryMenuElement extends HTMLElement implements CustomElement {
  ...
  constructor();
  connectedCallback(): void;
  addOptions<T extends CategoryLike>(
    options: T[],
    expandText: string,
    callbackFn: (category: T) => void,
  ): void;
...
declare class RealmedCategoryMenuElement extends HTMLElement implements CustomElement {
  ...
  addOptions<T extends SkillCategory>(
    categories: T[],
    expandText: string,
    callbackFn: (category: T) => void,
  ): void;
