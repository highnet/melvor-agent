...
declare class CompletionRequirement extends GameRequirement<CompletionPercentChangedEvent> {
  ...
  notifyFailure(): void;
  getHandler(
    callback: Handler<CompletionPercentChangedEvent>,
  ): Handler<CompletionPercentChangedEvent>;
...
declare class TownshipBuildingRequirement extends GameRequirement<TownshipBuildingCountChangedEvent> {
  ...
  notifyFailure(): void;
  getHandler(
    callback: Handler<TownshipBuildingCountChangedEvent>,
  ): Handler<TownshipBuildingCountChangedEvent>;
...
declare class CartographyPOIDiscoveryRequirement extends GameRequirement<CartographyPOIDiscoveredEvent> {
  ...
  notifyFailure(): void;
  getHandler(
    callback: Handler<CartographyPOIDiscoveredEvent>,
  ): Handler<CartographyPOIDiscoveredEvent>;
...
declare type AnyRequirement =
  ...
  | ShopPurchaseRequirement
  | SlayerItemRequirement
  | SlayerTaskRequirement
  | ItemFoundRequirement
  | MonsterKilledRequirement
  | TownshipTaskCompletionRequirement
  | TownshipBuildingRequirement
  | CartographyHexDiscoveryRequirement
  | CartographyPOIDiscoveryRequirement
  | ArchaeologyItemsDonatedRequirement
  | AbyssalLevelRequirement
  | SkillTreeNodeUnlockedRequirement
...
declare type AnyRequirementData =
  ...
  | TownshipTaskCompletionRequirementData
