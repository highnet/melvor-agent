...
declare function generateProductGPBreakdown(
  costReduction?: number,
  increasedQuantity?: number,
  preservation?: number,
): void;
declare function getModifiersForSkill(
  skill: AnySkill,
  useBase: boolean,
): {
...
declare class TrueRecipeInterval {
  ...
  setSkillBonuses(
    ...
    costReduction: number,
    increasedQuant: number,
    additionalResourceChance: number,
  ...
  generateTrueIntervalBreakdownForItemsCSV(
    baseGame?: boolean,
    TotH?: boolean,
    AoD?: boolean,
    ItA?: boolean,
