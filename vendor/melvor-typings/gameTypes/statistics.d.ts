...
declare class Statistics implements SkillObject<StatTracker>, Serializable, EncodableObject {
  ...
  getFilteredItemStatsDiff(
    predicate: (item: AnyItem) => boolean,
    statAdd: ItemStats,
    statSub: ItemStats,
  ): number;
...
declare enum CorruptionStats {
  TimesCorrupted = 0,
  TimesEnemyCorrupted = 1,
  MonstersAutoCorrupted = 2,
  SoulPointsSpent = 3,
}
declare enum HarvestingStats {
  Actions = 0,
  TimeSpent = 1,
