...
declare class SkillTreeNode
  ...
  implements SoftDataDependant<SkillTreeNodeData>
{
  tree: SkillTree;
  game: Game;
...
declare class SkillTree
  extends NamespacedObject
  implements EncodableObject, IGameEventEmitter<SkillTreeEvents>
{
  game: Game;
  skill: AnySkill;
  _events: import('mitt').Emitter<SkillTreeEvents>;
  on: {
    <Key extends keyof SkillTreeEvents>(
      type: Key,
      handler: import('mitt').Handler<SkillTreeEvents[Key]>,
    ): void;
  ...
  off: {
    <Key extends keyof SkillTreeEvents>(
      type: Key,
      handler?: import('mitt').Handler<SkillTreeEvents[Key]> | undefined,
    ): void;
    (type: '*', handler: import('mitt').WildcardHandler<SkillTreeEvents>): void;
  };
  get media(): string;
