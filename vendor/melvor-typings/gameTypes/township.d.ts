...
declare enum TownshipConvertQtyType {
  Number = 0,
  Percent = 1,
  AllButOne = 2,
}
declare enum TownshipConvertType {
  ToTownship = 0,
  FromTownship = 1,
}
...
declare class TownshipBuilding
  extends RealmedObject
  implements SoftDataDependant<TownshipBuildingData>
{
  get name(): string;
  get media(): string;
  get englishName(): string;
...
declare class TownshipWorship
  extends NamespacedObject
  implements SoftDataDependant<TownshipWorshipData>
{
  get name(): string;
...
declare class Township
  extends Skill<TownshipSkillData, TownshipEvents, TownshipModificationData>
  implements PassiveAction
{
  ...
  getBuildingEfficiencyInBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  ...
  getBasePopulationProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseEducationProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseHappinessProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseWorshipProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseStorageProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseFortificationProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  getBaseSoulStorageProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): number;
  ...
  getProvidesForBiome(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): TownshipBuildingProvides | undefined;
  ...
  isBuildingUpgradedButNotBuiltd(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ): boolean;
  ...
  getSingleResourceRepairCostForBuilding(
    building: TownshipBuilding,
    biome: TownshipBiome | undefined,
  ...
  getRepairCostInBiomeForBuilding(
    biome: TownshipBiome,
    building: TownshipBuilding,
    costs: Map<TownshipResource, number>,
  ): Map<TownshipResource, number>;
  ...
  updateConvertFromQty(
    value: number,
    resource: TownshipResource,
    conversion: TownshipItemConversion,
  ): void;
