...
declare type CombatTriangleSetData = BaseCombatTriangleData &
  Record<CombatTriangleType, CombatTriangle>;
declare class CombatTriangleSet
  extends NamespacedObject
  implements Record<CombatTriangleType, CombatTriangle>
{
  get name(): string;
  get media(): string;
  _name: string;
