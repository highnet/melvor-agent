...
The agent has **33 capabilities**. Each is a decision the planner can
...
| Township worship changes | costs 50,000,000 GP and destroys every worship building — the one change whose cost dwarfs any plan the agent could form around it |
